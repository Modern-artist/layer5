      ...
      <PricingWrapper>
        <div className="product_hero">
          <div className="product_hero_text">
            ...
            <p>
              ...
              application accross different cloud native infrastructure. Compare
              and manage cloud native overhead.{" "}
            </p>
            <div className="btn">
              <>
                <Button className="explore">Discover Products</Button>
              </>
            </div>
          </div>
        ...
        <div className="freeTry">
          ...
          <div className="headers rotate gap">
            ...
            <p>
              ...
              [specific outcomes, e.g., customer engagement, project efficiency,
              data analysis].
            </p>
        ...
        <div className="headers">
          ...
          <p>
            ...
            your [industry/field] journey. From startups to enterprises, we have
            a plan designed to fit your unique needs. Take the next step towards
            success and view our pricing and plans now.
          </p>
        </div>
        <Container>
          <Row Hcenter={true}>
        ...
        <div className="headers gap">
          ...
          <p>
            Book a demo with us now! Our experts are eager to guide you through
            the incredible possibilities of [Product/Service]. Don't miss this
            chance to revolutionize your [specific outcome]! Click below to
            schedule your demo.
          </p>
          <Button className="primary" />
        </div>
